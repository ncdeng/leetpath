...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: '/problems/:slug', component: ProblemView, meta: { hasInlineAi: true } },
    { path: '/quiz', component: QuizView, meta: { hasInlineAi: true } },
    { path: '/oncall', component: OnCallView, meta: { hasInlineAi: true } },
    { path: '/review', component: ReviewView, meta: { hasInlineAi: true } },
